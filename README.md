...
Commits are added gradually to show steady progress. Each commit focuses on one change or one problem at a time.
...
If anything fails during setup, the environment is lightweight and should work on any machine with Python and Jupyter installed.
